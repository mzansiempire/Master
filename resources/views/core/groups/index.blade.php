...
<div class="sbox animated fadeInRight">
	...
	<div class="sbox-content"> 	
	    <div class="toolbar-line ">
			@if($access['is_add'] ==1)
	   		<a href="{{ URL::to('core/groups/update') }}" class="tips btn btn-sm btn-primary"  title="{{ Lang::get('core.btn_create') }}">
			...
			<a href="{{ URL::to('core/groups/download') }}" class="tips btn btn-sm btn-info" title="{{ Lang::get('core.btn_download') }}">

...
<div class="sbox animated fadeInRight">
	...
	<div class="sbox-content"> 	
		 ...
		 {!! Form::open(array('url'=>'changereferrals/save?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
<div class="col-md-12">
						<fieldset><legend> Change Referrals</legend>
								  ...
								  <div class="form-group  " >
									...
									<div class="col-md-6">
									  {!! Form::text('age', $row['age'],array('class'=>'form-control', 'placeholder'=>'', 'required'=>'true', 'parsley-type'=>'number'   )) !!} 
									 </div> 
									 <div class="col-md-2">
								  ...
								  <div class="form-group  " >
									...
									<div class="col-md-6">
									  {!! Form::text('gender', $row['gender'],array('class'=>'form-control', 'placeholder'=>'', 'required'=>'true', 'parsley-type'=>'number'   )) !!} 
									 </div> 
									 <div class="col-md-2">
								  ...
								  <div class="form-group  " >
									...
									<div class="col-md-6">
									  {!! Form::text('province', $row['province'],array('class'=>'form-control', 'placeholder'=>'', 'required'=>'true'  )) !!} 
									 </div> 
									 <div class="col-md-2">
								  ...
								  <div class="form-group  " >
									<label for="Referrer" class=" control-label col-md-4 text-left"> Referrer <span class="asterix"> * </span></label>
									<div class="col-md-6">
									  <textarea name='referrer' rows='5' id='referrer' class='form-control '  
				         required  >{{ $row['referrer'] }}</textarea> 
									 </div> 
									 <div class="col-md-2">
			...
			<div style="clear:both"></div>	
				  ...
				  <div class="form-group">
					...
					<button type="button" onclick="location.href='{{ URL::to('changereferrals?return='.$return) }}' " class="btn btn-success btn-sm "><i class="fa  fa-arrow-circle-left "></i>  {{ Lang::get('core.sb_cancel') }} </button>
					</div>	  
